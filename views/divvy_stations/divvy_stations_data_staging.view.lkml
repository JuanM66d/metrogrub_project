# The name of this view in Looker is "Divvy Stations Data Staging"
view: divvy_stations_data_staging {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `divvy_stations.divvy_stations_data_staging` ;;
