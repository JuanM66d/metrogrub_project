# The name of this view in Looker is "Clean Population Counts"
view: clean_population_counts {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `chicago_demographics.clean_population_counts` ;;
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # This dimension will be called "Population 0 to 17" in Explore.
